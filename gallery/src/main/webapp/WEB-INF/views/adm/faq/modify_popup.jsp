...
<body>
	<div class="container">
		<form name="faq_form" id="faq_form" method="post">
			...
			<input type="hidden" id="no" name="no" value="${faqview.no}">
								...
								<tbody>
									<tr style="line-height: 32px;">
										...
										<td colspan="3"><input type="text" name="faq_title"
											id="faq_title" class="form-control" value="${faqview.faq_title}"></td>
									</tr>
									<tr style="line-height: 32px;">
										<td>답변:</td>
										<td colspan="3"><textarea name="faq_contents"
												id="faq_contents" class="form-control">${faqview.faq_contents}</textarea></td>
									</tr>
								</tbody>
							</table>
						</div>
