...
<script>
	function ajaxcheck() {
		...
		var form = new FormData(document.getElementById('profile_img_chahge'));
		...
		$.ajax({
			url : "/adm/profile_modify_IMG", //컨트롤러 URL
			data : form,
			dataType : 'text',
			processData : false,
			contentType : false,
...
<body>
	<div class="container">
		<form name="profile_img_chahge" id="profile_img_chahge" method="post">

			<div class="col-sm-12 pt-3">
				<div class="card">
					<div class="card-header card-header-primary">
						<h4 class="card-title">Profile IMG Change</h4>
