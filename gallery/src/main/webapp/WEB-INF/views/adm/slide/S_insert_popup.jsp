...
<script>
	function ajaxcheck() {
		...
		var form = new FormData(document.getElementById('slide_insert'));
...
<body>
	<div class="container">
		<form name="slide_insert" id="slide_insert" method="post">

			<div class="col-sm-12 pt-3">
				<div class="card">
					<div class="card-header card-header-primary">
						<h4 class="card-title">Slide IMG Insert</h4>
			...
			<div class="text-center mt-3">
				<button type="button" class="btn btn-success" onclick="ajaxcheck();">추가하기</button>
