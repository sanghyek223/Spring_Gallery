...
<script>
	function ajaxcheck() {
		...
		var form = new FormData(document.getElementById('slide_modify'));
...
<body>
	<div class="container">
		<form name="slide_modify" id="slide_modify" method="post">

			<div class="col-sm-12 pt-3">
				<div class="card">
					<div class="card-header card-header-primary">
						<h4 class="card-title">Slide IMG Modify</h4>
							...
							<table class="table">
								<tbody>
									<tr style="line-height: 32px;">
										<td>No:</td>
										<td colspan="1"><input type="text" name="no" readonly
											id="no" class="form-control"></td>
									</tr>
									<tr style="line-height: 32px;">
										<td>Change IMG:</td>
